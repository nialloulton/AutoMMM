...
class AutoModeller:
    ...
    def format_prompt(self, summary):
        ...
        Based on the summary, identify variables that are insignificant or not media-related and replace them with more promising untested variables. Think about the practical implications of your variable selection and the importance of domain knowledge when evaluating the model. Aim to improve the model's performance by minimizing AIC and maximizing R-squared, but also consider the overall quality and relevance of the variables you choose.
